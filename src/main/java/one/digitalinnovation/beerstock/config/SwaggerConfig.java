...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Nome SobreNome";
    private static final String CONTACT_GITHUB = "https://gtihub.com/seugithub";
    private static final String CONTACT_EMAIL = "nome.sobrenome@gmail.com";
